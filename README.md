...
Whilst the project included automated unit testing, manual testing and accessibility testing, there are several additional software testing activities that could be performed if the application were developed further. Regression testing could be carried out after future enhancements to ensure that existing functionality continues to operate correctly following code changes. Cross-browser testing would verify that the application behaves consistently across browsers such as Google Chrome and Microsoft Edge. Compatibility testing could also be performed across different operating systems and screen resolutions to ensure a consistent user experience. 

As my project develops further, User Acceptance Testing (UAT) would be beneficial by allowing users to evaluate the application and provide feedback on its usability before release. Finally, if the application were expanded into a larger or commercial project, performance testing, load testing and security testing would be important to ensure that the application remains responsive, reliable and secure when handling increased user activity and external data sources. 

From a personal perspective, this project has significantly improved both my technical knowledge and my understanding of the software testing lifecycle. At the start of the project I had limited experience using technologies such as HTML, CSS, JavaScript, Git, GitHub and Jest. Throughout the development process I became much more confident using these tools and gained a greater appreciation of how they work together to support software development and quality assurance. I also developed a better understanding of version control, project management and the importance of producing clear testing evidence alongside the application itself. 

Reflecting on my own performance, I believe there are several areas where I can continue to improve. Whilst I successfully applied a range of testing techniques, I would like to gain more practical experience designing more unit tests and using additional testing frameworks beyond Jest. I would also like to develop a deeper understanding of accessibility testing standards and gain more experience configuring CI/CD pipelines. 